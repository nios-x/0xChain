...
# 🏗️ System Architecture
        ...
        v                      v
+---------------+     +------------------+
| Prediction ML |     | Decision Engine  |
| (Delay Model) |     | (Graph Routing)  |
+-------+-------+     +--------+---------+
        |                      |
        +----------+-----------+
                   |
        ...
        +----------------------+
🔁 Workflow
📥 Collect real-time data (GPS, weather, traffic, etc.)
⚙️ Process streams and detect anomalies
🤖 Predict potential disruptions using ML models
🧭 Compute optimal alternate routes
🔄 Trigger rerouting or recommendations
📊 Update dashboard and notify stakeholders
