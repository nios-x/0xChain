...
import { Calendar, Clock, MapPin, Coffee, ShieldCheck, ChevronLeft, ChevronRight, Info } from "lucide-react";
        ...
        <div className="col-span-12">
           <div className="bg-surface rounded-xl border border-white/5 p-8">
              <div className="grid grid-cols-7 gap-4">
                 {weekDays.map((d, i) => (
                   <div key={i} className={`flex flex-col items-center p-6 rounded-xl border transition-all cursor-pointer ${
                      d.status === 'active' ? 'bg-primary/10 border-primary/40' : 
                      ...
                      <div className={`mt-4 w-1.5 h-1.5 rounded-full ${
                         d.status === 'active' ? 'bg-primary glow-primary animate-pulse' : 
