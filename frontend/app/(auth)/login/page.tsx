            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-8 mb-8 justify-center">
                <button
                  ...
                  className={`text-[14px] font-bold pb-2 w-1/2 text-center uppercase tracking-[0.1em] transition-colors ${activeTab === "login"
              ...
              {status === "authenticated" ? (
                <div className="text-center font-bold text-sm flex flex-col items-center gap-4">
                  <span className="text-green-600">Logged in as {session?.user?.email}</span>
                  <div className="flex gap-5">

                  <button onClick={() => signOut({ redirect: false })} className="h-[40px] px-4 mt-2 border  border-text-dim flex items-center justify-center gap-2 rounded-[80px] hover:bg-surface-container-highest transition-colors">
                    <span className="text-white text-[11px] font-bold uppercase tracking-[0.1em]">
                      Signout
                    </span>

                  </button>
                  <button onClick={()=>{ if(role) window.location.href = `/dashboard?q=${role}` }} className="h-[40px] px-4 mt-2  flex items-center justify-center gap-2 rounded-[80px] hover:bg-surface-container-highest bg-green-700 transition-colors">
                    <span className="text-white text-[11px] font-bold uppercase tracking-[0.1em]">
                      Continue
                    </span>
